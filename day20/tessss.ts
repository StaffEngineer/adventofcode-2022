...
console.log('999', getNthValue(zero, 999))
console.log('1000', getNthValue(zero, 1000))
console.log('1001', getNthValue(zero, 1001))
console.log('1999', getNthValue(zero, 1999))
console.log('2000', getNthValue(zero, 2000))
console.log('2001', getNthValue(zero, 2001))
console.log('3000', getNthValue(zero, 3000))
